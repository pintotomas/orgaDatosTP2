...
def procesar(df, relleno_nuls = None):
    ...
    cualidades = {"pileta":["pileta","piscina"], "chalet":["chalet"], "patio":["patio"], "esquina":["esquina"], "a estrenar":["a estrenar"], "amenities":["amenities"], "quincho":["quincho"], "cochera": ["cochera"], "transporte":["subte","tren"], "parrilla":["parrilla"],"aire acondicionado":["aire acondicionado"],"cocina":["cocina"],"living":["living"], "antigua":["antigua"], "terraza":["terraza"],"lavadero":["lavadero"],"suite":["suite"],"completo":["completo"],"balcon":["balcn"]}
